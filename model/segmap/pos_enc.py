...
class PositionEmbeddingCoordsSine(nn.Module):
    """Change from dvlab-research/SphereFormer's class PositionEmbeddingCoordsSine """
    def __init__(
        self,
        temperature=10000,
        normalize=False,
    ...
    def get_sine_embeddings(self, xyz, num_channels=None, input_range=None):
        ...
        if self.normalize:
            xyz = pcd_normalize(xyz)

        xyz = xyz.unsqueeze(0)  # add B dim
        ncoords = xyz.shape[1]
